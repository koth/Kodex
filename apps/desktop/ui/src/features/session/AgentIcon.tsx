...
/** DeepSeek whale in the brand blue — chunky rounded silhouette that stays legible at 16px. */
function DeepSeekMark({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="#4D6BFE" fillRule="evenodd" aria-hidden="true">
      {/* Body + two-pronged tail; the eye is a punched hole so it shows the row background */}
      <path d="M3.5 13.2C3.5 9.3 6.6 6.2 10.5 6.2c2.7 0 5.2 1.4 6.5 3.6.9-1.5 2.6-3.4 4.8-5-.3 2.1-.9 4.5-2 6.6.9 1.5 1.7 3.3 2.3 5.5-1.9-1-3.9-1.5-5.8-1.5-1.3 2.5-3.7 4.1-6.5 4.1-3.6 0-6.3-2.8-6.3-6.3Zm4.1-1a1.05 1.05 0 1 0 2.1 0 1.05 1.05 0 0 0-2.1 0Z" />
    </svg>
  );
}
